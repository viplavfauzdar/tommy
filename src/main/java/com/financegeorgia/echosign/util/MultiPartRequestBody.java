...
public class MultiPartRequestBody {
   ...
   * @throws IOException
   */
  public void addFilePart(String fileName, String mimeType, InputStream fileStream) throws IOException {
    writeBoundary(false);
    ...
    // Append the file stream.. the document that will be uploaded to EchoSign.
    //BufferedInputStream fileStream = (BufferedInputStream)file;    
    try {
