...
public class RestApiAgreements {
  ...
  private static Logger logger = Logger.getLogger(RestApiAgreements.class);
  ...
  /**
   * Uploads a transient document to the EchoSign server, typically as part of an agreement sending workflow. A "transient document" is a
  ...
  public static JSONObject postTransientDocument(String accessToken, String mimeType, String fileToBeUploaded, String uploadedFileName) throws Exception {
    ...
    String url = RestApiUtils.SERVICES_BASE_URL + TRANSIENT_DOCUMENTS_ENDPOINT;
    ...
    //URL fileUrl = RestApiAgreements.class.getResource(pathToFile);
    //File fileToUpload = new File(fileUrl.getPath());
    
    InputStream fileToUpload = RestApiAgreements.class.getResourceAsStream(pathToFile);
    logger.info(fileToUpload);
  ...
  public static JSONObject sendAgreement(String accessToken, String requestJsonFile, String documentId, DocumentIdentifierName idName) throws Exception {
    ...
    String url = RestApiUtils.SERVICES_BASE_URL + AGREEMENTS_ENDPOINT;
  ...
  public static JSONObject sendReminder(String accessToken, String requestJsonFile, String agreementId) throws Exception {
    ...
    String url = RestApiUtils.SERVICES_BASE_URL + REMINDERS_ENDPOINT;
  ...
  public static JSONObject getAgreementInfo(String accessToken, String agrId) throws Exception {
    ...
    String url = RestApiUtils.SERVICES_BASE_URL + AGREEMENTS_ENDPOINT + "/" + agrId;
  ...
  public static JSONObject getAgreementDocuments(String accessToken, String agrId) throws Exception {
    ...
    String url = RestApiUtils.SERVICES_BASE_URL + AGREEMENTS_ENDPOINT + "/" + agrId + DOCUMENTS_ENDPOINT;
  ...
  public static byte[] getDocumentBytes(String accessToken, String agrId, String docId) throws Exception {
    ...
    String url = RestApiUtils.SERVICES_BASE_URL + AGREEMENTS_ENDPOINT + "/" + agrId + DOCUMENTS_ENDPOINT + "/" + docId;
  ...
  public static byte[] getAgreementAuditTrailBytes(String accessToken, String agrId) throws Exception {
    ...
    String url = RestApiUtils.SERVICES_BASE_URL + AGREEMENTS_ENDPOINT + "/" + agrId + AUDIT_ENDPOINT;
  ...
  public static byte[] getAgreementCombinedBytes(String accessToken, String agrId) throws Exception {
    ...
    String url = RestApiUtils.SERVICES_BASE_URL + AGREEMENTS_ENDPOINT + "/" + agrId + COMBINEDDOC_ENDPOINT;
