...
public class RestApiLibraryDocuments {
   ...
   * @throws IOException
   */
  public static JSONObject getLibraryDocuments(String accessToken) throws IOException {
    // URL for library documents end point.
    String url = RestApiUtils.SERVICES_BASE_URL + LIBRARY_DOCUMENTS_ENDPOINT;
   ...
   * @throws IOException
   */
  public static JSONObject getLibraryDocuments(String accessToken, String emailId) throws IOException {
