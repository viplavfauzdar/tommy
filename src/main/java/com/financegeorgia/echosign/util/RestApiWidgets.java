...
//        "}";
      widgetCreationInfo.put("widgetCompletionInfo", widgetCompletionInfo);
      //widgetCompletionInfo..put("url", "http://24.126.148.51:8080/EchoSign?action=redirect&userId=6");
      System.out.println("Widget JSON: " + widgetCreationInfo.toJSONString());
  ...
  public static byte[] getFormdataForWidget(String accessToken, String widgetId) throws Exception {
    ...
    String url = RestApiUtils.SERVICES_BASE_URL + WIDGETS_ENDPOINT + "/" + widgetId + FORMDATA_ENDPOINT;
  ...
  public static JSONObject getWidgetInfo(String accessToken, String widgetId) throws Exception {
    ...
    String url = RestApiUtils.SERVICES_BASE_URL + WIDGETS_ENDPOINT + "/" + widgetId;
